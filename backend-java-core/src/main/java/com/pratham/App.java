...
import com.pratham.shazam.Fingerprint;
...
//        System.out.println( "All visualizations created." );
        ...
        try{
            Map<Integer, Couple> fingerprints = Fingerprint.generateFingerprintForAudio(1, "/home/prat/Downloads/file_example_WAV_1MG.wav");
            for(Map.Entry<Integer, Couple> entry : fingerprints.entrySet())
                System.out.println(entry.getKey() + ": " + entry.getValue());
        }catch (Exception e){
            System.out.println("Error: song file not found");
        }
    }
}